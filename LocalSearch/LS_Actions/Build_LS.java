...
public class Build_LS extends Build implements Node_LS,ChildC_LS  {
	...
	public void sample(int budget) {
		...
		if(ggg==2||this.getN().getN()==null) {
			...
			int g = gerador.nextInt(l3.size()*100) %l3.size();
			n.setN(l3.get(g));
			this.setN(n);
		}

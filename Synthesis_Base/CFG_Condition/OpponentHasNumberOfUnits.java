...
public class OpponentHasNumberOfUnits implements ChildB {
	...
	public void interpret(GameState gs, int player, Unit u, Interpreter automato) throws Exception {
    	...
    	if(automato.me.ContainsInt(this.type.getValue()+"enemy")) {
    		int n_actully = automato.me.getInt(this.type.getValue()+"enemy");
    		
    		 this.value = n_actully<n_int;
    		 return;
		 ...
		 automato.me.setInt(this.type.getValue() +"enemy",cont);

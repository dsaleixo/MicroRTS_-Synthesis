...
public class For_S implements ChildS {
	...
	public void interpret(GameState gs, int player, Unit u, Interpreter automato) throws Exception {
		...
		if(automato.me.containblockTable(this.translate())) {
			return;
		}
		for(Unit u2:pgs.getUnits() ) {	
            if(u2.getPlayer()==player && automato.getAbstractAction(u2)==null ) {
            	this.child.interpret(gs, player,u2, automato);
   
            }

		 }
		automato.me.setblockTable(this.translate());
	}
	...
	public String translate2() {
		// TODO Auto-generated method stub
		 return "for(Unit u){|" +this.child.translate2()+"|}endFor";
	}
